...
// Added React.SVGProps<SVGSVGElement> to Icon components to allow passing className and other attributes.
// The {...props} spread is placed at the end to allow caller-provided attributes to override defaults.
export const Icons = {
